      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 mt-4 text-lg max-w-2xl mx-auto">
            Your contribution helps us create real impact. Every donation,
            small or big, makes a meaningful difference.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center bg-white rounded-3xl shadow-xl p-10">
          ...
          <div>
            ...
            <div className="bg-gray-50 p-4 rounded-xl space-y-2">
              <p><strong>Account Name:</strong> SHAHEED E AZAM SPORTS FOUNDATION</p>
              <p><strong>Bank:</strong> Axis Bank of India</p>
              <p><strong>Account No:</strong> 925010013625060</p>
              <p><strong>IFSC:</strong>UTIB0003114 </p>
            </div>
